...
class District(AbstractBaseModel):
    ...
    supretendent = models.OneToOneField(
...
class DistrictReport(AbstractBaseModel):
    district = models.ForeignKey(
        District, on_delete=models.CASCADE, related_name="reports"
    )
...
class DistrictAttendance(AbstractBaseModel):
    ...
    district = models.ForeignKey(
        District, on_delete=models.CASCADE, related_name="districtattendance"
    )
...
class DistrictFinance(AbstractBaseModel):
    report = models.ForeignKey(DistrictReport, on_delete=models.CASCADE, null=True)
    district = models.ForeignKey(
        District, on_delete=models.CASCADE, related_name="districtfinances"
    )
    section = models.ForeignKey(
        "sections.Section", on_delete=models.SET_NULL, null=True
    )
    ...
    resource_mobilisation = models.DecimalField(
...
class SectionReport(AbstractBaseModel):
    report = models.ForeignKey(DistrictReport, on_delete=models.CASCADE, null=True)
    district = models.ForeignKey(
        District, on_delete=models.CASCADE, related_name="districtsectionreports"
    )
    section = models.ForeignKey(
        "sections.Section", on_delete=models.SET_NULL, null=True
    )
...
class DistrictExpense(AbstractBaseModel):
    report = models.ForeignKey(DistrictReport, on_delete=models.CASCADE, null=True)
    district = models.ForeignKey(
        District, on_delete=models.CASCADE, related_name="districtexpenses"
    )
