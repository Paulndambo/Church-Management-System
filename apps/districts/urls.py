...
urlpatterns = [
    ...
    path("district-reports/", views.DistrictReportListView.as_view(), name="district-reports"),
    path("district-reports/<int:id>/details/", views.district_report_details, name="district-report-details"),
    path("new-report/", views.new_report, name="new-report"),
    path("edit-report/", views.edit_report, name="edit-report"),
         

    path("district-expenses/", views.DistrictExpenseListView.as_view(), name="district-expenses"),
