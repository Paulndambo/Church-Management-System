...
urlpatterns = [
    path(
        "service-attendances/",
        views.ServiceAttendanceMetricsListView.as_view(),
        name="service-attendances",
    ),
    path(
        "record-service-attendance/",
        views.record_service_attendance,
        name="record-service-attendance",
    ),
    ...
    path(
        ...
        views.delete_church_service,
        name="delete-church-service",
    ),
    path(
        "member-attendances/",
        views.ServiceAttendaceView.as_view(),
